...
// _feed_inner_text_area — avatar + floating "Write something …" textarea
// (with pencil label), bottom row of Photo / Video / Event / Article SVG
// buttons, and the paper-plane Post button. Static markup.
