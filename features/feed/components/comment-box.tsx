...
import { mockCurrentUser } from '@/features/users/data/mock';

// _feed_inner_comment_box — the "Write a comment" composer rendered inside
// each post card. Static markup; submit handler will be wired when the
// comments API integration branch lands.
    ...
    <div className="_feed_inner_comment_box">
      <form className="_feed_inner_comment_box_form">
        <div className="_feed_inner_comment_box_content">
          <div className="_feed_inner_comment_box_content_image">
            <Avatar
              ...
              fallback="/assets/images/comment_img.png"
            />
          </div>
        ...
        <div className="_feed_inner_comment_box_icon">
          <button type="button" className="_feed_inner_comment_box_icon_btn" aria-label="Microphone">
          ...
          <button type="button" className="_feed_inner_comment_box_icon_btn" aria-label="Attach">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16">
              <path
                fill="#000"
                fillOpacity=".46"
